...
INSERT INTO dds.reward_tokens (symbol, "chain", contract_addr, tvl, 
	...
	price_change_60d, price_change_200d, "date_")
SELECT DISTINCT symbol, dc.id, contract_addr, tvl, mcap_to_tvl, fdv_to_tvl,
	mcap, market_cap_rank, fdv, price_change_24h, price_change_7d,
	price_change_30d, price_change_60d, price_change_200d, current_date
FROM stg.reward_tokens rt 
